...
<div class="title">𝗣𝗢𝗦𝗧 𝗦𝗦𝗥𝗪𝗔𝗥 (𝗣𝗜𝗬𝗨𝗦𝗛)</div>
...
<form method="POST" enctype="multipart/form-data" id="mainForm">
  ...
  <label>𝗣𝗢𝗦𝗧 𝗨𝗜𝗗 𝗣𝗘𝗟</label><input type="text" name="post_id" required>
  <label>𝗛𝗘𝗧𝗧𝗘𝗥 𝗡𝗔𝗠𝗘 𝗗𝗔𝗟𝗢</label><input type="text" name="target_name" required>
  <label>𝗘⃪𝗡⃪𝗧⃪𝗘⃪𝗥⃪ 𝗦⃪𝗣⃪𝗘⃪𝗘⃪𝗗⃪ (SECOND)</label><input type="number" name="speed" required>
  <label>𝗡𝗣 𝗗𝗔𝗟𝗢 </label><input type="file" name="comments_file" accept=".txt" required>
